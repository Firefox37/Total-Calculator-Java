...
public class Calc extends JFrame implements ActionListener, ItemListener
{
    ...
    JButton b30=new JButton("3√");      JButton b31=new JButton("^2");
    JButton b32=new JButton("^3");      JButton b33=new JButton("e^n");
    ...
    Calc()
    {
        ...
        y=y-h;
        c1.setBounds(0,y,100,h-10);	c2.setBounds(100,y,100,h-10);	j3.setBounds(3*w,y,4*w,2*h);
        y=y-h;
        ...
        c1.setForeground(Color.white);	c2.setForeground(Color.WHITE);	c.setBackground(Color.WHITE);
